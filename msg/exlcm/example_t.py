...
class example_t(object):
    ...
    __slots__ = ["timestamp", "position", "torque", "name"]

    __typenames__ = ["int64_t", "int32_t", "double", "string"]
    ...
    def _encode_one(self, buf):
        buf.write(struct.pack(">qid", self.timestamp, self.position, self.torque))
    ...
    def _decode_one(buf):
        self = example_t()
        self.timestamp, self.position, self.torque = struct.unpack(">qid", buf.read(20))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0xc173565d4699a250) & 0xffffffffffffffff
